...
task = """
        Write a concise but engaging blogpost about The 21 Irrefutable Laws of Leadership. 
...
# a team of reviewers (SEO, Legal, Ethics, Meta)
#
...
def reflection_message(recipient, messages, sender, config):
    return f"""Review the following content and provide constructive feedback to help improve the quality of the content. 
